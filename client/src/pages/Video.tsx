            ...
            <div className="min-h-screen bg-gradient-to-b from-background to-muted/20 p-6 md:p-8">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-12 text-center">
                        ...
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Upload up to 5 images and describe your vision. Our AI will create a video based on your prompt.</p>
                    </div>
