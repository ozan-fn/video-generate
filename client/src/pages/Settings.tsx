            ...
            <div className="container py-6">
                ...
                <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <div className="rounded-lg border border-border bg-card p-6">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">Control how you receive notifications and updates.</p>
                        <Button variant="outline" size="lg">
                    ...
                    <div className="rounded-lg border border-border bg-card p-6">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">Customize the look and feel of your application.</p>
                        <Button variant="outline" size="lg">
                            Theme Settings
                        </Button>
                    </div>
